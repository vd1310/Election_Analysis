...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_results = (
            f"{county_name}: {vote1_percentage:.1f}% ({votes1:,})\n")
        ...
        if (votes1 > winning_county_votes) and (vote1_percentage > winning_county_percentage):
            winning_county_votes = votes1
            winning_county = county_name
            winning_county_percentage = vote1_percentage
